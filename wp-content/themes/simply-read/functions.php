...
function myScripts() {
	...
	wp_register_script( 'jquery', '/wp-content/plugins/responsive-photo-gallery/js/jquery.min.js' );
	wp_register_script( 'bootstrap', '/wp-content/plugins/responsive-photo-gallery/js/bootstrap.min.js' );
	wp_register_script( 'light', '/wp-content/plugins/responsive-photo-gallery/js/lightbox.min.js' );

	wp_register_style( 'bootstrap', '/wp-content/plugins/responsive-photo-gallery/css/bootstrap.min.css' );

	wp_register_style( 'light', '/wp-content/plugins/responsive-photo-gallery/css/lightbox.css' );
